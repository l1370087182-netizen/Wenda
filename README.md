...
每天定时采集六类资讯（科技 / 地缘 / 财经 / AI 技术 / 最新 AI 资讯 / GitHub 热点），多 Agent 编排完成去重、评分、摘要、影响分析、跨类关联洞察，08:00 发送每日一封订阅日报；网页看板 + 多轮研究问答。
...
| 时间 | 任务 | 说明 |
|---|---|---|
| 07:00 | collect_daily | 多 Agent 流水线：采集（异常自动换源）→ 去重 → 分析 → digest → 交叉洞察 → 主编审查 |
